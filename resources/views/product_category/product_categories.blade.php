                        ...
                        <tr class="intro-x">
                            ...
                            <td class="table-report__action w-56">
                                <form action="{{ route('products.destroy', $product->id) }}"
                                    ...
                                    <a class="flex items-center mr-3" href="{{ route('products.show', $product->id) }}"><i
                                            data-feather="check-square" class="w-4 h-4 mr-1"></i>Show</a>
                                    <a class="flex items-center mr-3" href="{{ route('products.edit', $product->id) }}"><i
                                            data-feather="check-square" class="w-4 h-4 mr-1"></i>Edit</a>
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="flex items-center text-theme-6"><i data-feather="trash-2"
                ...
                <table class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center whitespace-no-wrap">Name</th>
                            <th class="text-center whitespace-no-wrap">Price</th>
                            <th class="text-center whitespace-no-wrap">Cat_Id</th>
                            <th class="text-center whitespace-no-wrap">Action</th>
                        </tr>
                    </thead>
                    @foreach ($products as $product)
